...
export class Util {
	...
	async replaceLocalImagesWithCloudUrls(app: App, isReplaceAll: boolean, tencentOSServer: TencentOSServer): Promise<void> {
	...
	private async replace(app: App, activeFile: TFile, tencentOSServer: TencentOSServer) {
